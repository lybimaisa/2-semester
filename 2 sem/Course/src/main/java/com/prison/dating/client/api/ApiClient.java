...
public class ApiClient {
    ...
    public static String addPrisoner(String prisonerNumber, String fullName, String birthDate) throws IOException {
        String params = "prisonerNumber=" + encode(prisonerNumber) +
                "&fullName=" + encode(fullName) +
                "&birthDate=" + encode(birthDate != null ? birthDate : "");
        return sendRequest("POST", "/prisoners/add", params);
    }
