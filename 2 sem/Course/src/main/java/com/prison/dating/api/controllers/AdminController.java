    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (pathInfo == null || "/".equals(pathInfo)) {
                ...
                out.println("{\"success\": true, \"message\": \"Запрос " + requestId + " одобрен (заглушка)\"}");
                ...
                // POST /api/admin/add-prisoner
                String fullName = request.getParameter("fullName");
                String birthDateStr = request.getParameter("birthDate");
                String prisonerNumber = request.getParameter("prisonerNumber");
                out.println("{\"success\": true, \"message\": \"Заключенный добавлен (заглушка)\"}");
